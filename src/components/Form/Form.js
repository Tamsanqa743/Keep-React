...
const Form = (props) =>{
    ...
    // const titleChangeHandler = (event)=> setInput((prevState)=>{
    //     return {
    //         ...prevState,
    ...
    // const textChangeHandler = (event)=> setInput((prevState)=>{
    //     return {
    //         ...prevState,
    ...
    return (
        ...
        <div className="form-container active-form" >
                <form onSubmit={submitFormHandler} className="form" id="form">
                    <input id = "note-title" type="text"  value={title} className="note-title" placeholder="Title" onChange = {titleChangeHandler} />
